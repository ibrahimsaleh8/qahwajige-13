...
export default function Footer({
  ...
  return (
    <footer className="border-t border-black/5 relative z-10 overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
              <Link
                href="/"
                className="text-black flex items-center gap-2 mb-6 text-xl font-bold hover:text-main-color transition-colors">
                {brandName}
              </Link>
              ...
              <ul className="space-y-3">
                {footerLinks.company.map((link) => (
                  <li key={link.name}>
                    <Link
                      href={link.href}
                      className="text-black/80 hover:text-main-color transition-colors inline-block">
                      {link.name}
                    </Link>
                  </li>
                ))}
